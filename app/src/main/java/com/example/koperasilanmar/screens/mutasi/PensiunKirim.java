...
import com.example.koperasilanmar.utils.router.services.ServiceKirimPensiun;
...
public class PensiunKirim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle){
        ...
        setContentView(R.layout.activity_kirim_pensiun);
        ...
        tgl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(PensiunKirim.this,date,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH)).show();
        ...
        materialButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new AlertDialog.Builder(PensiunKirim.this).setMessage("Apakah anda yakin ingin untuk Pensiun ?")
                        .setPositiveButton("Iya", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                if(!ids.isEmpty()){
                                    ...
                                    ServiceKirimPensiun serviceKirimPensiun = new ServiceKirimPensiun();
                                    if(!tgl.getText().toString().equals("2001 / 03 / 03")){
                                        serviceKirimPensiun.getModel(body).observe(PensiunKirim.this, new Observer<JsonObject>() {
                                            @Override
                                            public void onChanged(JsonObject jsonObject) {
                                                ...
                                                if (jsonObject.get("msg").toString().contains("Berhasil")){
                                                    ...
                                                    Intent i = new Intent(PensiunKirim.this, Home.class);
                                                    i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                                    startActivity(i);
                                                    finish();
                                                }else {
                                                    new AestheticDialog.Builder(PensiunKirim.this, DialogStyle.EMOTION, DialogType.SUCCESS)
                                                            .setTitle("Error")
                                        ...
                                        new AestheticDialog.Builder(PensiunKirim.this, DialogStyle.RAINBOW, DialogType.ERROR)
                                                .setTitle("Error")
