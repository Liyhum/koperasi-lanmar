...
import com.example.koperasilanmar.screens.mutasi.Mutasi;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.MyView> {
    ...
    public UsersAdapter(Activity adminAll,ArrayList<User> modelLists){
    ...
    public class MyView extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            Intent intent = new Intent(adminAll, Mutasi.class);
            intent.putExtra("id",modelLists.get(getLayoutPosition()).getIdMutasi());
