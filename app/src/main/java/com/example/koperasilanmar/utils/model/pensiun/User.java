...
package com.example.koperasilanmar.utils.model.pensiun;
...
public class User {
    ...
    @SerializedName("id_pensiun")
    @Expose
    private Integer idPensiun;
    ...
    public Integer getIdPensiun() {
        return idPensiun;
    }

    public void setIdPensiun(Integer idPensiun) {
